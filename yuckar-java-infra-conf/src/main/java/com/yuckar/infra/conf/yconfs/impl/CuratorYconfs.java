...
public class CuratorYconfs<V> extends AbstractYconfs<V> {

	private final Map<String, LazySupplier<CuratorCache>> caches = Maps.newConcurrentMap();
	private final CuratorFramework curator;

	public CuratorYconfs(CuratorFramework curator, Class<V> clazz) {
		this(curator, clazz, null);
	}

	public CuratorYconfs(CuratorFramework curator, Class<V> clazz, Function<String, Set<YconfsListener<V>>> listeners) {
