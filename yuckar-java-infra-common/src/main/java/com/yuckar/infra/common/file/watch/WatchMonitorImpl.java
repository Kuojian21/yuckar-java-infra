...
public class WatchMonitorImpl implements IWatch {

	public static WatchMonitorImpl of(long interval) {
		return new WatchMonitorImpl(interval);
	}
	...
	public WatchMonitorImpl(long interval) {
