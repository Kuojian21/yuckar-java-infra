...
public class N_humanUtils {
	...
	public static String formatMills(Stopwatch stopwatch) {
		return formatMills(stopwatch, 2);
	}

	public static String formatMills(Stopwatch stopwatch, int scale) {
		return formatMills(stopwatch.elapsed(TimeUnit.MILLISECONDS), scale);
	}
